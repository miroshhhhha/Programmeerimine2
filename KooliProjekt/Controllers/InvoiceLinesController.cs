...
namespace KooliProjekt.Controllers
{
    public class InvoiceLinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InvoiceNo,InvoiceDate,DueDate")] InvoiceLine invoiceLine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InvoiceNo,InvoiceDate,DueDate")] InvoiceLine invoiceLine)
        {
